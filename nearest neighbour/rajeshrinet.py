...
eqSteps = 1*2**10       #  number of MC sweeps for equilibration
mcSteps = 1*2**10       #  number of MC sweeps for calculation
...
plt.plot(T,E)#plt.scatter(T, E, s=50, marker='-', color='IndianRed')
plt.xlabel("Temperature (T)", fontsize=20);
plt.ylabel("Energy ", fontsize=20);         plt.axis('tight');


sp =  f.add_subplot(2, 2, 2 );
plt.plot(T,abs(M))#plt.scatter(T, abs(M), s=50, marker='-', color='RoyalBlue')
plt.xlabel("Temperature (T)", fontsize=20); 
